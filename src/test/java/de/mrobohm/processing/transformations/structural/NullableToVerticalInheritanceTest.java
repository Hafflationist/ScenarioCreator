...
class NullableToVerticalInheritanceTest {
    ...
    void transformWithPrimaryKey() {
        ...
        var invalidTable1 = new Table(new IdSimple(10), name,
                List.of(invalidColumn1), Context.getDefault(), SSet.of());
        var invalidTable2 = new Table(new IdSimple(11), name,
                List.of(invalidColumn0, invalidColumn2), Context.getDefault(), SSet.of());
        var targetTable = new Table(new IdSimple(14), name,
                List.of(primaryKeyColumn1, primaryKeyColumn2, validColumn), Context.getDefault(), SSet.of());
    ...
    void getCandidates() {
        ...
        var validColumn = new ColumnLeaf(new IdSimple(4), name, dataType.withIsNullable(true), ColumnContext.getDefault(), SSet.of());

        var invalidTable1 = new Table(new IdSimple(10), name,
                List.of(invalidColumn1), Context.getDefault(), SSet.of());
        var invalidTable2 = new Table(new IdSimple(11), name,
                List.of(invalidColumn1, invalidColumn2), Context.getDefault(), SSet.of());
        var validTable = new Table(new IdSimple(14), name,
                List.of(invalidColumn1, invalidColumn2, validColumn), Context.getDefault(), SSet.of());
