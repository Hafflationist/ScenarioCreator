...
class ColumnLeafsToTableTest {
    ...
    void transform() {
        ...
        var targetTable = new Table(new IdSimple(6), targetTableName,
                List.of(columnLeaf, columnLeafGroupable1, columnLeafGroupable2), Context.getDefault(), SSet.of());
    ...
    void getCandidates() {
        ...
        var columnLeafGroupable1 = columnLeaf.withConstraintSet(SSet.of()).withId(new IdSimple(3));
        var columnLeafGroupable2 = columnLeaf.withConstraintSet(SSet.of()).withId(new IdSimple(4));
        var validTable = new Table(new IdSimple(6), name, List.of(columnLeaf, columnLeafGroupable1, columnLeafGroupable2), Context.getDefault(), SSet.of());
