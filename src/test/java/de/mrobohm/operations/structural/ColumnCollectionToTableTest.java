...
class ColumnCollectionToTableTest {
    ...
    void transform() {
        ...
        var columnCollection = new ColumnCollection(5, name, List.of(columnLeafSub1, columnLeafSub2), Set.of(), false);
        var targetTable = new Table(6, name, List.of(columnLeaf, columnCollection), Context.getDefault(), Set.of());
    ...
    void getCandidates() {
        ...
        var columnLeafSub2 = columnLeaf.withId(4);
        var columnCollection = new ColumnCollection(5, name, List.of(columnLeafSub1, columnLeafSub2), Set.of(), false);
        var validTable = new Table(6, name, List.of(columnLeaf, columnCollection), Context.getDefault(), Set.of());
